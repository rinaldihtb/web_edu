<?php 
class ControllerDowntempTemplate {
	public function index() {
		...
		*/
		...
		$model = $tools->load("downtemp/template");
		...
		include_once "apps/views/downtemp/list.php";
	...
	public function edit() {
		...
		$tools = new Tools();
		$model = $tools->load("downtemp/template");
		$results = $model->getTemplate($_GET['id']);
		...
		include_once "apps/views/common/header.php";
		include_once "apps/views/common/sidebar.php";
		include_once "apps/views/downtemp/edittemplate.php";
		include_once "apps/views/common/footer.php";
	...
	public function simpan() {
		...
		if($_POST) {
			...
			$model = $tools->load("downtemp/template");
			if($data['tipe']=="tambah") 
				$model->tambahTemplate($data);
			else if ($data['tipe']=="edit") {
				$model->editTemplate($data, $_GET['id']);
			}
		}
		/*echo "<pre>";
		print_r($_POST);
		...
		$tools->redirect("http://$_SERVER[HTTP_HOST]/admin_edu/index.php?route=downtemp/template");
	}
